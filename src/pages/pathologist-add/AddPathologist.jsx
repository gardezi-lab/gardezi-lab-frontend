...
export default function AddPathologist() {
    return (
        <>
                        ...
                        <div className="table-responsive mt-4">
                            <table className="table table-lg fs-9 mb-0 w-100">
                                ...
                                <tbody className="list">
                                    <tr>
                                        <td className="align-middle ps-3 name">Dr. Shahzad Sarwar</td>
                                        <td className="align-middle" style={{ color: '#ff2929', fontWeight: 'bold' }}>121343242</td>
                                        <td className="align-middle">shehzad</td>
                                        <td className="align-middle text-start">MBBS, FCPS(Clinical Hematology) <br />
                                            Clinical Hematologist</td>
                                        <td className="align-middle">Hematology,</td>
