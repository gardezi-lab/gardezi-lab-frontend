...
export default function LabModal({ isShowDepartmentModal, setIsShowDepartmentModal, modalHeader, updateObj, refreshList }) {
        ...
        <>
            <Modal show={isShowDepartmentModal} size="md" centered>
                <Modal.Header className="primary" size="sm">
                    <Modal.Title className="color-white fw-bold">Lab Modal</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Container>
                        <Form>
