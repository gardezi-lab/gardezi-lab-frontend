        ...
        <div className="container-fluid mt-0 p-0" style={{ paddingRight: "1%" }}>
            ...
            >
                <div
                    ...
                    <h5 className="mb-1 text-white">Custom Number DB </h5>
                    <hr />
                </div>
                ...
                <div className="card-body">
                    <div className="col-md-2">
                        <label for="fromDate" class="form-label">Name</label>
                        <input type="text" className="form-control" placeholder="Name" id="fromDate" name="fromDate" />
                    </div>
                    <div className="col-md-2">
                        <label for="toDate" class="form-label">NO</label>
                        <input type="text" placeholder="cell# Formate  03217384177" className="form-control" id="toDate" name="toDate" />
                    </div>
